 ...
 *
 * <p>
 * One of the ways to do this in case of org.jacoco.maven-surefire-plugin - is to use
 * syntax for <a href=
 ...
 * <pre>
 *   &lt;plugin&gt;
 *     &lt;groupId&gt;org.apache.org.jacoco.maven.plugins&lt;/groupId&gt;
 *     &lt;artifactId&gt;org.jacoco.maven-surefire-plugin&lt;/artifactId&gt;
 *     &lt;configuration&gt;
 ...
 * property evaluation and jacoco-org.jacoco.maven-plugin not executed.
 * </p>
 *
 * <p>
 * Another way is to define "argLine" as a Maven property rather than as part of
 * the configuration of org.jacoco.maven-surefire-plugin:
 * </p>
 *
 * <pre>
 *   &lt;properties&gt;
